...
class PendingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final pendingOrders = orderDataProvider.orders
        .where((order) => order['status']?.toString().toLowerCase() == 'pending')
        .toList();
    ...
    return Scaffold(
      ...
      body: orderDataProvider.isLoading
          ...
          : pendingOrders.isEmpty
              ? const Center(
                  child: Text(
                    'No customers with pending status',
